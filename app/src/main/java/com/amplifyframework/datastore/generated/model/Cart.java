...
public final class Cart implements Model {
  ...
  private final @ModelField(targetType="FoodPost", isRequired = true) @HasMany(associatedWith = "cart", type = FoodPost.class) List<FoodPost> cartPost = null;
  ...
  public List<FoodPost> getCartPost() {
      return cartPost;
  }
